...
constexpr uint16_t FRAME_SCHEDULER_TOLERANCE_US = 1000;
...
constexpr uint16_t ASSET_IO_TASK_STACK_WORDS = 6144;
constexpr uint16_t APP_LOGIC_TICK_MS = 5;
constexpr uint16_t NETWORK_TASK_PERIOD_MS = 20;
constexpr uint16_t ASSET_IO_TASK_PERIOD_MS = 500;
...
constexpr uint16_t BATTERY_DEFAULT_MIN_MV = 6200;
constexpr uint16_t BATTERY_DEFAULT_MAX_MV = 8000;
constexpr uint8_t BATTERY_PERCENT_HYSTERESIS_PCT = 1;
constexpr uint8_t BATTERY_PERCENT_HYSTERESIS_TENTHS = 6;
...
constexpr uint16_t CHARGE_DETECT_HYSTERESIS_LOW_MV = 3000;
constexpr uint16_t CHARGE_DETECT_CHARGING_MIN_MV = 4000;
constexpr uint16_t CHARGE_DISPLAY_THRESHOLD_MV = 4500;
...
constexpr uint16_t HTTP_CMD_MAX_BYTES = 256;
constexpr size_t NETWORK_STATUS_JSON_POOL_BYTES = 2048;
...
constexpr size_t SETTINGS_JSON_POOL_BYTES = 1024;
