# File Description: This script automatically prepares fonts, resources, builds and uploads firmware/filesystem; PowerShell parameters and command names remain in English.
param(
...
function Remove-LegacyFontResources([string]$FontDir) {
    ...
    $LegacyNames = @(
        ...
        # Note: unifont.woff2 is now a standalone WebUI font resource, generated by Build-AndEmbedUnifontWebFont
